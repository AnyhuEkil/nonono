package com.cto.auction.controller.auctionBoard;
...
import com.cto.auction.service.auctionBoard.AuctionBoardService;
import com.cto.auction.vo.auctionBid.AuctionBid;
import com.cto.auction.vo.auctionBoard.AuctionBoard;
import com.cto.auction.vo.auctionBoard.AuctionBoardPage;
...
public class AuctionBoardController {
	...
	public ModelAndView boardList(@RequestParam(defaultValue="board_title") String option,
		...
		// 페이지 나누기 관련 처리
		AuctionBoardPage boardPage = new AuctionBoardPage(count, curPage);
	...
	public String updateProc(@ModelAttribute AuctionBoard upt, HttpSession session){
		service.update(upt);
		// view화면은 item/item
		return "redirect:list.do?auction_id="+session.getAttribute("auction_id");
	}
