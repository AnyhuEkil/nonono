package com.cto.auction.service.auctionBoard;
...
import com.cto.auction.repository.auctionBoard.AuctionBoardDAO;
...
public class AuctionBoardService {
	...
	// 게시판 리스트 작성
	public ArrayList<AuctionBoard> boardList(int start, int end, String option, String keyword, int auction_id){
		// Map 선언
...
// 			세션에 시간을 저장 : "update_time_"+board_id는 다른변수와 중복되지 않게 명명한 것
	...
	// 답글 작성
	public void replyInsert(AuctionBoard reply){
		// 답글 모양 설정
	...
	public AuctionBoard getReply(int board_id, HttpSession session){
		AuctionBoard reply = null;
		// 게시글 불러오기
